...
fig.append_trace(go.Scatter(x=y_pred_scale['x'], y=y_pred_scale['calculated_ec'], name="pulsewidth"), row = 1, col=2)
...
fig.append_trace(go.Scatter(x=y_pred_scale['x'], y=y_pred_scale['calculated_ec'], name="spotsize"), row = 2, col=1)
...
fig.append_trace(go.Scatter(x=y_pred_scale.x, y=y_pred_scale.calculated_ec, name="targetthickness"), row = 2, col=2)
